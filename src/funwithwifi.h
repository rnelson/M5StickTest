/* https://github.com/n0xa/m5stick-nemo/blob/main/wifispam.h */
...
void displayNetwork(int channel, const char SSID[]) {
  //char displayBuffer[90];
	//sprintf(displayBuffer, "%n - %s", channel, SSID);
  ...
  //M5.lcd.println(String(displayBuffer));
...
void beaconSpam(const char ESSID[]){
  ...
  displayNetwork(set_channel, ESSID);
